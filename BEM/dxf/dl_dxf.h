...
#define DL_ENTITY_3DFACE	   123  //CHANGED by KS
#define DL_BLOCK_RECORD			124  //CHANGED by KS
...
public:
	...
	void add3DFace(DL_CreationInterface* creationInterface);//Changed by KS
	void addBlockRecord(DL_CreationInterface* creationInterface);//Changed by KS
